...
#define ROBOT_STATUS_ESTOP                  5U   /* 紧急刹车状态位 */

#ifndef M_PI
#define M_PI 3.14159265358979323846f
#endif

#define ROBOT_MOTOR_FULL_STEPS_PER_REV      200U
#define ROBOT_MOTOR_MICROSTEP               256U
#define ROBOT_MOTOR_STEPS_PER_REV           (ROBOT_MOTOR_FULL_STEPS_PER_REV * ROBOT_MOTOR_MICROSTEP)
#define ROBOT_MOTOR_STEPS_PER_REV_16X       (ROBOT_MOTOR_FULL_STEPS_PER_REV * 16U)
...
#define ROBOT_ASSIST_RESET_J2_LIFT_ANGLE    (20.0f) /* 辅助复位时joint[2]先抬起的角度 */
#define ROBOT_ASSIST_RESET_J3_NEG_ANGLE     (30.0f) /* 辅助复位时joint[3]负方向转动的角度 */
#define ROBOT_ASSIST_RESET_J4_NEG_ANGLE     (0.0f)  /* 辅助复位时joint[4]负方向转动的角度 */
#define ROBOT_ASSIST_RESET_J2_DROP_ANGLE    (20.0f) /* 辅助复位时joint[2]再放下的角度 */
...
enum robot_event_type
{
    ...
    ROBOT_JOINTS_SYNC_REL_EVENT,    /* 关节同步相对运动事件：六个关节按相对角度同步开始运动 */
};
